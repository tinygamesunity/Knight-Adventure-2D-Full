...
public class GrapeProjectile : MonoBehaviour {
    ...
    [SerializeField] private GameObject grapeProjectileSplatterPrefab;
    ...
    private void Start() {
        ...
        GameObject grapeProjectileShadow = Instantiate(grapeProjectileShadowPrefab, transform.position, Quaternion.identity);
    ...
    private IEnumerator ProjectileCurveRoutine(Vector3 startPosition, Vector3 endPosition) {
        ...
        Instantiate(grapeProjectileSplatterPrefab, transform.position, Quaternion.identity);
        Destroy(gameObject);
    }
