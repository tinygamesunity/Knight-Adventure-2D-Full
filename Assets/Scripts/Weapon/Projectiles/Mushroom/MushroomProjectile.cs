...
public class MushroomProjectile : MonoBehaviour {
    ...
    [SerializeField] private GameObject mushroomProjectileShadowPrefab;
    [SerializeField] private GameObject mushroomProjectileSplatterPrefab;
    ...
    private void Start() {
        ...
        GameObject grapeProjectileShadow = Instantiate(mushroomProjectileShadowPrefab, transform.position, Quaternion.identity);
    ...
    private IEnumerator ProjectileCurveRoutine(Vector3 startPosition, Vector3 endPosition) {
        ...
        Instantiate(mushroomProjectileSplatterPrefab, transform.position, Quaternion.identity);
        Destroy(gameObject);
    }
